...
function load(){
  ...
  // get data from HTML element "rawdata"
...
request.open("GET", "https://raw.githubusercontent.com/MinorDelay/Dataprocessing/master/Homework/Week%202/KNMI_20111231.txt");
request.send();
